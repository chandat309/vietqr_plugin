...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
    ...
    if (request.action === "speak") {
        ...
        const speechText = "Cảm ơn quý khách đã thanh toán số tiền " + currencyAmount.toString() + " đồng.";
        let utterance = new SpeechSynthesisUtterance(speechText);
        utterance.lang = "vi-VN";
        utterance.voice = window.speechSynthesis.getVoices().filter(function (voice) { return voice.lang === 'vi-VN'; })[0];
